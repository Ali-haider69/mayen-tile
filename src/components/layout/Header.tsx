...
export function Header() {
  ...
  return (
    ...
    >
          ...
          <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
            <div className="flex items-center gap-6">
              ...
              >
                ...
                <span className="font-light tracking-wide">{SITE_CONFIG.phone}</span>
              </a>
              <a
              ...
              >
                ...
                <span className="font-light tracking-wide">{SITE_CONFIG.email}</span>
              </a>
            </div>
      ...
      <div
        className={cn(
          "lg:hidden fixed inset-0 top-0 bg-primary z-50 transition-all duration-500 flex flex-col",
          mobileOpen
        ...
        <nav className="flex-1 flex flex-col justify-center px-10 gap-1">
          {NAV_LINKS.map((link, i) => (
            <Link
              key={link.href}
              href={link.href}
              className="text-3xl font-serif text-white/80 hover:text-accent-light py-3 transition-colors border-b border-white/5"
              onClick={() => setMobileOpen(false)}
